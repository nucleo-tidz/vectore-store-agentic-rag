...
namespace api.Controllers
{
    ...
    public class ShipmentController( Kernel kernel, IProjectAgent projectAgent) : ControllerBase
    {
        ...
        {
            //A container scheduled for dispatch has a gross weight of 9500 kg and a volume of 28.3 CBM. It is designated for a FuelSensitive route and requires special handling due to the presence of hazardous materials. Please calculate the total shipping cost using a base rate of ₹1001 per CBM.
